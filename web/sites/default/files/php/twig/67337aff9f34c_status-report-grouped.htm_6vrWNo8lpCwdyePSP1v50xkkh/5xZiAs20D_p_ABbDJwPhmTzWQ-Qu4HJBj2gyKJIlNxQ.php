...
class __TwigTemplate_96aa2e130669195df53a9a1636300ebe extends Template
{
...
$context["group"], "type", [], "any", false, false, true, 32), ["warning", "error"])) ? (("system-status-report__status-icon system-status-report__status-icon--" . $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["group"], "type", [], "any", false, false, true, 32), 32, $this->source))) : (""))];
                // line 35
                yield "              <div";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->createAttribute(["class" => $this->sandbox->ensureToStringAllowed(($context["summary_classes"] ?? null), 35, $this->source)]), "html", null, true);
                yield " role=\"button\">
                ";
                // line 36
